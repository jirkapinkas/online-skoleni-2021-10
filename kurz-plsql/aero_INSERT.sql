...
INSERT INTO zamestnani (nazev_pozice, popis_prace) VALUES ('Pilot', 'Pilotování letù');
...
INSERT INTO zamestnani (nazev_pozice, popis_prace) VALUES ('Provozní chemik', 'Kontrola technického stavu letadel, podpora pro oddìlení výzkumu a vývoje');
INSERT INTO zamestnani (nazev_pozice, popis_prace) VALUES ('Dispeèer letového provozu', 'Kontrola a øízení letového provozu');
INSERT INTO zamestnani (nazev_pozice, popis_prace) VALUES ('Hlavní dispeèer letového provozu', 'Kontrola a øízení letového provozu, dohled nad ostatními dispeèery');
INSERT INTO zamestnani (nazev_pozice, popis_prace) VALUES ('Øeditel aerolinek', 'Øeditel spoleènosti');
INSERT INTO zamestnani (nazev_pozice, popis_prace) VALUES ('Uklízeèka', 'Zametání, mytí, drhnutí, špionáž u konkurence');
INSERT INTO zamestnani (nazev_pozice, popis_prace) VALUES ('Instruktor pilotáže letadel', 'Instruktor školící piloty');

INSERT INTO zamestnanec (zamestnani_id, nadrizeny, jmeno, prijmeni, plat, datum_nastupu, datum_ukonceni, aktivni) VALUES ((SELECT zamestnani_id FROM zamestnani WHERE nazev_pozice = 'Øeditel aerolinek'), NULL, 'Michael', 'Boss', 230000, TO_DATE('20.01.2000', 'dd.MM.YYYY'), NULL, 'y');
INSERT INTO zamestnanec (zamestnani_id, nadrizeny, jmeno, prijmeni, plat, datum_nastupu, datum_ukonceni, aktivni) VALUES ((SELECT zamestnani_id FROM zamestnani WHERE nazev_pozice = 'Hlavní dispeèer letového provozu'), (SELECT zamestnanec_id FROM zamestnanec WHERE jmeno = 'Michael' AND prijmeni = 'Boss'), 'Milan', 'Flemming', 80000, TO_DATE('03.12.2002', 'dd.MM.YYYY'), NULL, 'y');
...
INSERT INTO zamestnanec (zamestnani_id, nadrizeny, jmeno, prijmeni, plat, datum_nastupu, datum_ukonceni, aktivni) VALUES ((SELECT zamestnani_id FROM zamestnani WHERE nazev_pozice = 'Dispeèer letového provozu'), (SELECT zamestnanec_id FROM zamestnanec WHERE jmeno = 'Milan' AND prijmeni = 'Flemming'), 'Radek', 'Vosièka', 63000, TO_DATE('11.01.2008', 'dd.MM.YYYY'), NULL, 'y');
...
INSERT INTO zamestnanec (zamestnani_id, nadrizeny, jmeno, prijmeni, plat, datum_nastupu, datum_ukonceni, aktivni) VALUES ((SELECT zamestnani_id FROM zamestnani WHERE nazev_pozice = 'Dispeèer letového provozu'), (SELECT zamestnanec_id FROM zamestnanec WHERE jmeno = 'Helena' AND prijmeni = 'Rosická'), 'Ondøej', 'Kotrba', 55000, TO_DATE('02.02.2003', 'dd.MM.YYYY'), NULL, 'y');
...
INSERT INTO zamestnanec (zamestnani_id, nadrizeny, jmeno, prijmeni, plat, datum_nastupu, datum_ukonceni, aktivni) VALUES ((SELECT zamestnani_id FROM zamestnani WHERE nazev_pozice = 'Dispeèer letového provozu'), (SELECT zamestnanec_id FROM zamestnanec WHERE jmeno = 'Jan' AND prijmeni = 'Ostrovid'), 'Jiøí', 'Koneèný', 45000, TO_DATE('24.07.2007', 'dd.MM.YYYY'), NULL, 'y');
...
INSERT INTO zamestnanec (zamestnani_id, nadrizeny, jmeno, prijmeni, plat, datum_nastupu, datum_ukonceni, aktivni) VALUES ((SELECT zamestnani_id FROM zamestnani WHERE nazev_pozice = 'Dispeèer letového provozu'), (SELECT zamestnanec_id FROM zamestnanec WHERE jmeno = 'Roman' AND prijmeni = 'Herzog'), 'Zdenìk', 'Omáèka', 58000, TO_DATE('11.04.2000', 'dd.MM.YYYY'), NULL, 'y');
...
INSERT INTO zamestnanec (zamestnani_id, nadrizeny, jmeno, prijmeni, plat, datum_nastupu, datum_ukonceni, aktivni) VALUES ((SELECT zamestnani_id FROM zamestnani WHERE nazev_pozice = 'Uklízeèka'), (SELECT zamestnanec_id FROM zamestnanec WHERE jmeno = 'Michael' AND prijmeni = 'Boss'), 'Kristýna', 'Tichá', 19000, TO_DATE('02.04.2000', 'dd.MM.YYYY'), NULL, 'y');
...
INSERT INTO zamestnanec (zamestnani_id, nadrizeny, jmeno, prijmeni, plat, datum_nastupu, datum_ukonceni, aktivni) VALUES ((SELECT zamestnani_id FROM zamestnani WHERE nazev_pozice = 'Pilot'), (SELECT zamestnanec_id FROM zamestnanec WHERE jmeno = 'David' AND prijmeni = 'Weigel'), 'Zdenìk', 'Vesecký', 115000, TO_DATE('05.06.2004', 'dd.MM.YYYY'), NULL, 'y');
...
INSERT INTO pilot (zamestnanec_id, hodnost) VALUES ((SELECT zamestnanec_id FROM zamestnanec WHERE jmeno = 'Zdenìk' AND prijmeni='Vesecký'), 'Captain');
...
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Milan', 'Zaváøka');
...
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Zlata', 'Stavaøová');
...
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Monika', 'Rychtáøová');
...
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Ondøej', 'Vetchý');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Kristián', 'Kulièka');
...
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Radek', 'Dìda');
...
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Filip', 'Rusnoviè');
...
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Jožko', 'Ïurovec');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Kamil', 'Vejváøka');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Gustav', 'Tišenko');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Táòa', 'Hrochová');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Gotlieb', 'Hesna');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Karel', 'Gott');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Richard', 'Krajèo');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Robert', 'Hajný');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Ladislav', 'Øedkvièka');
...
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Leoš', 'Kuzmoviè');
...
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Milena', 'Zvíøetová');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('René', 'Živoèicháø');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Tomáš', 'Stanìk');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Ladislav', 'Votoèka');
...
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Nadìžda', 'Ulrichová');
...
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Ondøej', 'Konipas');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Ladislav', 'Vlk');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Roman', 'Šakal');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Boøek', 'Stavitel');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Karkulka', 'Èervená');
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Libìna', 'Rozumná');
...
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Zdenìk', 'Hraboš');
...
INSERT INTO pasazer (jmeno, prijmeni) VALUES ('Veronika', 'Viknáøová');
...
INSERT INTO ucastnik_letu (cislo_letu, pasazer_id, odkud, kam, cena, pocet_prestupku) VALUES ('OK5', (SELECT pasazer_id FROM pasazer WHERE jmeno = 'Milan' AND prijmeni = 'Zaváøka'), (SELECT destinace_id FROM destinace WHERE nazev = 'Dubai'), (SELECT destinace_id FROM destinace WHERE nazev = 'Malaga'), 2340.90, 0);
...
INSERT INTO ucastnik_letu (cislo_letu, pasazer_id, odkud, kam, cena, pocet_prestupku) VALUES ('OK5', (SELECT pasazer_id FROM pasazer WHERE jmeno = 'Ondøej' AND prijmeni = 'Konipas'), (SELECT destinace_id FROM destinace WHERE nazev = 'Dubai'), (SELECT destinace_id FROM destinace WHERE nazev = 'Malaga'), 2340.90, 0);
...
INSERT INTO ucastnik_letu (cislo_letu, pasazer_id, odkud, kam, cena, pocet_prestupku) VALUES ('OK7', (SELECT pasazer_id FROM pasazer WHERE jmeno = 'Filip' AND prijmeni = 'Rusnoviè'), (SELECT destinace_id FROM destinace WHERE nazev = 'Madrid'), (SELECT destinace_id FROM destinace WHERE nazev = 'Paris'), 1578.0, 0);
...
INSERT INTO ucastnik_letu (cislo_letu, pasazer_id, odkud, kam, cena, pocet_prestupku) VALUES ('OK7', (SELECT pasazer_id FROM pasazer WHERE jmeno = 'Leoš' AND prijmeni = 'Kuzmoviè'), (SELECT destinace_id FROM destinace WHERE nazev = 'Paris'), (SELECT destinace_id FROM destinace WHERE nazev = 'Istanbul'), 2420.0, 0);
INSERT INTO ucastnik_letu (cislo_letu, pasazer_id, odkud, kam, cena, pocet_prestupku) VALUES ('OK15', (SELECT pasazer_id FROM pasazer WHERE jmeno = 'Milena' AND prijmeni = 'Zvíøetová'), (SELECT destinace_id FROM destinace WHERE nazev = 'London'), (SELECT destinace_id FROM destinace WHERE nazev = 'Prague'), 1800.0, 0);
...
INSERT INTO ucastnik_letu (cislo_letu, pasazer_id, odkud, kam, cena, pocet_prestupku) VALUES ('OK17', (SELECT pasazer_id FROM pasazer WHERE jmeno = 'Boøek' AND prijmeni = 'Stavitel'), (SELECT destinace_id FROM destinace WHERE nazev = 'London'), (SELECT destinace_id FROM destinace WHERE nazev = 'Moscow'), 3340.0, 0);
...
INSERT INTO ucastnik_letu (cislo_letu, pasazer_id, odkud, kam, cena, pocet_prestupku) VALUES ('OK12', (SELECT pasazer_id FROM pasazer WHERE jmeno = 'Richard' AND prijmeni = 'Tesaøík'), (SELECT destinace_id FROM destinace WHERE nazev = 'Stockholm'), (SELECT destinace_id FROM destinace WHERE nazev = 'Ekaterinburg'), 3100.0, 0);
